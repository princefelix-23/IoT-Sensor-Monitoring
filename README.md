...
- **File Format**: JSON
- **File Naming Convention**: unique naming convention generated by Stream Analytics if not define. We could've set a file format with the following naming concention `[identifier]-[description].json`.
